      ...
      <section className={styles.container}>
        ...
        <div className={styles.textBlock}>
          ...
          <div className={styles.links}>
            ...
            <a href="https://www.figma.com/proto/ghF7xs4mzV1Dn8Lkl1QY1N/Untitled?node-id=1-4068&t=g3isglPHdRw0JOZO-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1&starting-point-node-id=1%3A3972&show-proto-sidebar=1" className={styles.underline}>Figma Link</a>
          </div>
        </div>
        ...
        <div className={styles.center}>
          ...
          Its minimalistic design reinforces brand recognition and allows it to be versatile enough for different uses. 
          The monochromatic palette adds timelessness and adaptability.
