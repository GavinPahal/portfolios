      ...
      <section className={styles.container}>
        ...
        <div className={styles.textBlock}>
          ...
          <div className={styles.links}>
            ...
            <a href="#" className={styles.underline}>Figma Link</a>
          </div>
        </div>
        ...
        <div className={styles.center}>
          ...
          The GoldiBite logo is a sleek, modern wordmark that prioritizes readability and professionalism. 
          ...
          <img src="/images/wordmark2 1.png" alt="GoldiBite Logo Variation" />
          <img src="/images/webHorizontal 1.png" alt="GoldiBite Logo" />

        </div>

        {/* Low-Fi vs Hi-Fi Before/After */}
        <h2 className={styles.heading}>Low-Fi vs Hi-Fi</h2>
        <BeforeAfter before="/images/Group 186.png" after="/images/Organge cans 1.png" />
