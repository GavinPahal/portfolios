...
const Sections = () => {
  return (
    <section className={styles.sections}>
      ...
      <img src="/images/Group 1 1.png" alt="Flow State Diagram" />
      ...
      <h2>User Persona</h2>
      Personas shape GoldiBite’s design. Alex, with severe allergies, needs instant alerts.
       Emily, a vegetarian avoiding gluten, relies on clear ingredient breakdowns. 
       Their needs guide the app’s simplicity, speed, and accuracy.
      <img src="/images/Screenshot 2025-02-08 192123 1.png" alt="User Persona" />
    </section>
  );
};
