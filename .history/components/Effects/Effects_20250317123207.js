  ...
  return (
    <section className={styles.dielines}>
      ...
      <h2 className={styles.title}>Video</h2>
        ...
        I focused on teaching how to shoot and score effortlessly, plus some smooth dribbling techniques.
         I used After Effects to add cool visuals and effects that kept it engaging and easy to follow. 
         The goal was to help players level up their game while keeping the video fast-paced and exciting. In the end, 
         it wasn’t just about showing skills—it was about creating a video that grabs attention and makes learning fun.
