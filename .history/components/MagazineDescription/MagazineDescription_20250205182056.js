  ...
  return (
    <section className={styles.description}>
      <div className={styles.container}>
        <img src="/images/missing-image.png" alt="Magazine Design" className={styles.image} />
        <div className={styles.text}>
          ...
          <p>
            ...
            clean layouts, intuitive navigation, and a user-centered approach that makes every interaction smooth.
          </p>
        </div>
      </div>
    </section>
